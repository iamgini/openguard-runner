...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "node" do |node|
        ...
        node.vm.provision :shell, path: "vagrant-files/node-config.sh"
        ...
        node.vm.provision "ansible" do |ansible|
            ...
            ansible.playbook = "vagrant-files/og-runner-config.yaml"
            #ansible.extra_vars = {
            #    node_ip: "192.168.100.10",
            #}
        end

        #config.vm.provision "file", source: "/.", destination: "/home/ansible"
        #config.vm.synced_folder "./", "/home/ansible/"
